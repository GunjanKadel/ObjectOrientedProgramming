...
Link :  https://onlinegdb.com/BJ3nmyjbv
2. Write a program in C++to overload the area interest to compute simple interest and compound interest where rate of interest is set to default 9.5. Also show with user defined rate of interest.

Link :  https://onlinegdb.com/BJ3nmyjbv
3. Write a program to allocate n spaces dynamically to allocate for integers. Enter values and find the sum and average. The value of n is enter by user from keyboard.


Link :  https://onlinegdb.com/ry8JN1obD

** Lab 3 **

1.Write a program  in c++to create a class to show the use of static and non static data members and member functions.

Link :  https://onlinegdb.com/Hk8U4eVMw

1.Write a program in C++to create a class to show overloading of member functions where make one member function as online and another as non online.

Link :  https://onlinegdb.com/HJedEgEfD

2.Write a program to create a class student  having roll, and 5 subject marks. Input and display the details of two students along with average mark.

Link :  https://onlinegdb.com/SkxiFVl4GP
...
Link :  https://onlinegdb.com/B1kReVaGP
...
Link :   https://onlinegdb.com/SyH-ZEpGv
...
Link : https://onlinegdb.com/S1GQZETzP
...
Link : https://onlinegdb.com/ryz4-E6fP

5.Create a class which stores name, author and price of a book. Store information for
n number of books. Display information of all the books in a given price range using friend function.
Link : https://onlinegdb.com/Hye8-ETMD

** Lab 5 **


1.Create a class complex which stores real and imaginary part of a complex number. 
...
Link : https://onlinegdb.com/HJgEJOJ4v

2. Create a class which stores time in hh:mm format. Include all the constructors. The 
parameterized constructor should initialize the minute value to zero, if it is not 
provided. 

Link : https://onlinegdb.com/H1MB1uJED

3. Create a class which stores a string and its length as data members. Include all the 
constructors. Include a member function to join two strings and display the 
concatenated string. 

Link : https://onlinegdb.com/Bky-Gdk4D

4. WAP to demonstrate the order of call of constructors and destructors for a class.

Link : https://onlinegdb.com/rJbPQ_yVv
 
5. WAP to count number of objects created from a class using concept of static data 
members and static member function.

Link : https://onlinegdb.com/r1BT7dk4P

** Lab 6 **

1..Create a class distance which stores a distance in feet and inches. Input 2 distance values 
...
Link : a) https://onlinegdb.com/BkN_1h_Nw

      b) https://onlinegdb.com/rkP412ONw
...
Link : https://onlinegdb.com/r17iJn_4v

** Lab 7 **



Q1.Write a program to create a class students having average marks as it's data member.Create two object and add user defined values entered by user from keyboard and add to both the object separately and display them by overloading binary plus operator and display them.

Answer: https://onlinegdb.com/rJbbE5a8D


Q2.Write a program to create a class students having average marks as it's data member.Create two object and add user defined values entered by user from keyboard and add to both the object separately and display them by overloading binary plus operator and display them.Perform using friend function 

Answer: https://onlinegdb.com/HJLb45p8v

Q3.  .Write a program to create a class students having average marks as it's data member.Add these properties of one object to another object by using member and friend function and display them

Answer: https://onlinegdb.com/By_-49pUv

Q4. Write a program to create a class students having average marks as it's data member. Overload binary plus operator to add two objects and store results to another object using member and friend function

Answer: https://onlinegdb.com/BycZN96LD
